    ...
    public function payViaAjax(Request $request)
    {
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'shipping_total' => 5656,
                'order_date' => 'Pending',
                'order_timestamps' => $post_data['cus_add1'],
                'delivery_address' => $post_data['cus_add1'],
                'payment_type' => $post_data['cus_add1'],
                'transaction_id' => $post_data['tran_id'],
                'currency' => $post_data['currency']
            ]);
        ...
        if ($order_details->order_status == 'Pending') {
            ...
            if ($validation) {
                ...
                */
                ...
                return redirect('/complete-order')->with('message', 'Transaction is successfully Completed');
            }
            ...
            return redirect('/complete-order')->with('message', ' Transaction is Invalid');
        }
    }
